...
export class ExtractAndInsertService {
  ...
  async selectAndInputUpdate(tableInput: any, select: any, columnsUpdate: any) {
    try {
      ...
      console.log('Inserção/Atualização realizada com sucesso');
    } catch (error) {
      console.error(error);
  ...
  async selectAndInputMov(tableInput: any, select: any) {
    try {
      ...
      console.log('Inserção dos dados realizada com sucesso');
    } catch (error) {
      console.error(error);
      throw new InternalServerErrorException();
    }
